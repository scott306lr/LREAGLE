...
class Model(nn.Module):
    ...
    def forward(
        ...
        # print("A: attention_mask: ", attention_mask.shape)
        # # print attention_mask, by replacing all the min values with 1 in integer form
        # mask_to_print = attention_mask.cpu().numpy()
        # mask_to_print[mask_to_print == torch.finfo(torch.float32).min] = 1
        # print(mask_to_print)
