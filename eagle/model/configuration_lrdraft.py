...
class TTTLRDraftConfig(PretrainedConfig):
    r"""
...
class LRDraftConfig(PretrainedConfig):
    r"""
    ...
    def __init__(
        ...
        num_hidden_layers=1, # [MODIFIED] single layer for draft model
        num_attention_heads=32,
...
if __name__ == "__main__":
    # lrdraft_config = LRDraftConfig()
    # lrdraft_config.save_pretrained("lrdraft-llama7b")
    lrdraft_config = TTTLRDraftConfig()
    lrdraft_config.save_pretrained("lrdraft-ttt-llama7b")
