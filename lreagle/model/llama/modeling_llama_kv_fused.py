...
# There are mainly modifications:
# 1. Removed Flash Attention 2.0 implementation, for easier maintenance.
# 2. Fuse several operations for better performance.
...
# [MODIFIED] Replace original LlamaMLP with fused version.
class LlamaMLP(nn.Module):
    def __init__(self, config):
        ...
        self.swiglu = SwiGLU(self.hidden_size, self.intermediate_size, bias=False, _pack_weights=True)
...
class LlamaAttention(nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        # ! Not sure the belowing line is correct, following Medusa. This is yet to be tested.
