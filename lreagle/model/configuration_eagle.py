...
class EagleConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        draft_model_name_or_path="yuhuili/EAGLE-llama2-chat-7B", # [MODIFIED] target model path
        **kwargs,
    ):
...
if __name__ == "__main__":
    lrdraft_config = EagleConfig
    lrdraft_config.save_pretrained("eagle-llama7b")
